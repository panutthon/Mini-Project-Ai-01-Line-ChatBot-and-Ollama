...
def llama_generate_response(prompt):
    ...
    payload = {
        ...
        "prompt": prompt+'Do not answer in more than 20 words, คุณเป็นผู้เชี่ยวชาญเรื่องทุเรียน',
        "stream": False
    }
...
def compute_response(sentence):
    ...
    if score > 0.5: # If the similarity score is above a certain threshold, use the new API-based method to generate a response
